...
- **Dependencies**: Issue tracker, `specs/`, `templates/pbi-template.md`, `.plans/` or `.cursor/plans/`. **Outbound**: Created issues are picked up by `/start-task`, `/decompose-task`, `/refine-task`.
